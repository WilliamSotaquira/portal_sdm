            ...
            function dibujarElementosGovco(pages, page) {
                ...
                if (page > 1) {
                    ...
                    liTag +=
                        '<li class="page-item-ts prev-page-ts disabled-ts"><a href="#" aria-disabled="true" tabindex="-1"><span class="prev-page-icon-ts"></span><span class="prev-page-text-ts">Anterior</span></a></li>';
                }

                if (pages < 6) {
                    for (var p = 1; p <= pages; p++) {
                        active = page === p ? "active-ts" : "no";
                        var ariaCurrentP = page === p ? ' aria-current="page"' : '';
                    ...
                    for (var n = beforePages; n <= afterPages; n++) {
                        ...
                        var ariaCurrentN = page === n ? ' aria-current="page"' : '';
                        liTag += '<li class="page-item-ts number-ts ' + active + '"><a href="#" data-page="' +
                ...
                if (page < pages) {
                    ...
                    liTag +=
                        '<li class="page-item-ts next-page-ts disabled-ts"><a href="#" aria-disabled="true" tabindex="-1"><span class="next-page-icon-ts"></span><span class="next-page-text-ts">Siguiente</span></a></li>';
                }
