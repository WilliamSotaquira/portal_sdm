...
@section('content')
    ...
    <link href="https://fonts.googleapis.com/css2?family=Sora:wght@100;200;300;400;500;600;700;800&amp;display=swap"
        rel="stylesheet"><!-- ----- Bloque Sección (Drupal 9 / Bootstrap Barrio) ----- -->
    <div class="container-fluid seccion">
        <div class="encabezado">
            <div class="row">
                <div class="col-12 col-sm-6 col-md-6">
                    <span class="imagen-descripcion">Área verde de Faldas del Cerro de Guadalupe con avenida circunvalar,
                        Bogotá. FOTO: César David Martínez.&nbsp;</span>
                </div>
                <div class="col-12 col-sm-6 col-md-6">
                    <div class="box-encabezado">
                        ...
                        <div class="parrafo">
                            <p>
                                ...
                                responsabilidades, practicas, procedimientos, procesos y recursos para determinar y alcanzar
                                la política del Sistema de Gestión Ambiental.
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="box-politicas">
            <div class="box-parrafos">
                ...
                <div class="parrafo">
                    <p>
                        La Secretaría Distrital de Movilidad consciente de la responsabilidad en la preservación del
                        ambiente, en el marco de su misionalidad, está comprometida con la mejora continua de las
                        condiciones ambientales de la entidad y su propósito como líder del sector frente a la formulación y
                        ejecución de políticas de movilidad sostenible, por lo tanto, ejecuta estrategias que fomentan la
                        cultura ambiental y fortalecen las buenas prácticas ambientales institucionales de acuerdo con la
                        legislación ambiental vigente.
                    </p>
                    <p>
                        Como parte de este compromiso, la Secretaría realiza una revisión periódica del contexto interno y
                        externo, así como de las necesidades y expectativas de las partes interesadas, incluyendo la
                        naturaleza, magnitud e impactos ambientales de sus actividades, trámites y servicios, con el fin de
                        incorporarlas en la formulación, actualización y aplicación de esta política ambiental, asegurando su
                        pertinencia y eficacia.
                    </p>
                    <p>
                        Esta política ambiental proporciona el marco de referencia para el establecimiento y revisión de los
                        objetivos ambientales de la entidad. Así pues, en el marco de la presente política, la Secretaría
                        Distrital de Movilidad se compromete a:
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="s1">
            <div class="row box-compromisos">
                ...
                <div class="col-12">
                    <ul class="compromisos-lista" aria-label="Compromisos de la Política Ambiental">
                        <li>Cumplir con los requisitos legales ambientales y otros aplicables a la Entidad.</li>
                        <li>Establecer estrategias enfocadas a garantizar el uso racional de los recursos, la protección del
                            medio ambiente, la prevención de la contaminación, y la mitigación de impactos ambientales
                            negativos derivados de sus actividades, reduciendo de esta forma las afectaciones al medio
                            ambiente.</li>
                        <li>Realizar seguimientos permanentes al desempeño del Sistema de Gestión Ambiental (SGA), que
                            permitan su implementación, control y mejora continua.</li>
                        <li>Implementar mecanismos al interior de la Entidad que permitan fortalecer en los colaboradores y
                            partes interesadas, el consumo responsable de los recursos naturales.</li>
                        <li>Ejecutar acciones orientadas a la mitigación y adaptación frente al cambio climático, protección
                            de la biodiversidad y los ecosistemas.</li>
                    </ul>
                </div>
            </div>
            <div class="hoja">
                    ...
                    <div class="box-parrafos">
                        ...
                        <div class="parrafo">
                            <p>
                                ...
                                impactos ambientales generados por las actividades institucionales, en las diferentes sedes
                        ...
                        <div>
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-6 col-md-8">
                                    ...
                                    <ul>
                                        <li data-list-item-id="e32c704339a3165b6e243fef3bc1bc6fb">
                                            Implementar el Programa de Ahorro y Uso Eficiente del Agua para la optimización
                                            de los recursos en las diferentes sedes que conforman la Secretaría Distrital de
                                            Movilidad.
                                        </li>
                                        <li data-list-item-id="e594cdaaa050ddffc96875ecb942fda41">
                                        ...
                                        <li data-list-item-id="e40c5e71110bdd9d98e058ea2d5904982">
                                        ...
                                        <li data-list-item-id="e2b54171bd79f324437119892344666ac">
                                        ...
                                        <li data-list-item-id="ee5a6d03ca502e8a6839d4706e647a538">
                                        ...
                                        <li data-list-item-id="e3eadfd4d1eefee298a485ebf3e60217f">
                    ...
                    <div class="col-12 col-sm-8 offset-sm-4 col-md-8">
                        ...
                        <div class="parrafo">
                            <p>
                                ...
                                asociados e influyendo en la mejora del desempeño ambiental y cumplimiento misional de la
                                entidad.
                            </p>
                        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="box-parrafos">
                        <div class="titulo">
                            <h3>
                                Resolución número 107311 de 2021
                            </h3>
                        </div>
                        <div class="parrafo">
                            <p>
    ...
    <style type="text/css">
        ...
        .s1 .compromisos-lista li {
            margin-bottom: 12px;
            line-height: 1.5;
            font-weight: 500;
        }

        .s1 .compromisos-lista li:last-child {
            margin-bottom: 0;
        }

        /* OBJETIVOS - IMAGEN */
        .s2 .box-parrafos .titulo {
            padding: 8px 0 14px 0;
        }

        .s2 .box-parrafos .titulo h3 {
            margin: 0;
            padding: 0 0 12px 0;
            text-align: center;
            border-bottom: 2px solid #a8ce05;
        }

        .s2 .box-parrafos .parrafo {
            padding-top: 14px;
        }
